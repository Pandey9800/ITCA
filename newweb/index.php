                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            ...
                            <h6 class="text-center" style="color:#fff;">EASIEST WAY OF E-FILING YOUR INCOME TAX RETURN IN INDIA
                        ...
                        <div class="col-lg-4 col-12 mb-4 mb-lg-0">
                            <div class="custom-block bg-white shadow-lg">
                                <a href="apply">
                                    <div class="d-flex">
                                        <div>
                                            <h5 class="mb-2">ITR Apply</h5>

                                            <p class="mb-0">Trust us, you can file your Income tax return on your own. Its Easy, quick and free when you file ITR with Tax2win on your own.
.</p>
                                        </div>

                                    </div>

                                    <img src="https://upload.wikimedia.org/wikipedia/commons/1/13/Logo_of_Income_Tax_Department_India.png" class="custom-block-image img-fluid" alt="">
                                </a><br/><a href="apply" class="btn custom-btn mt-2 mt-lg-3">Apply Now</a>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="design-tab-pane" role="tabpanel" aria-labelledby="design-tab" tabindex="0">
                                    <div class="row">
                                        <?php 
					$catq=mysqli_query($con,"SELECT `id`, `cast`,`details`, `timedate` FROM `cat` ORDER BY `cast` DESC");
					 while($catrun=mysqli_fetch_array($catq)){?>
                                        <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                                            <div class="custom-block bg-white shadow-lg">
                                                <a href="#service-list?sid=<?php echo ($catrun['id']); ?>">
                                                    <div class="d-flex">
                                                        <div>
                                                            <h5 class="mb-2"><?php echo ucwords($catrun['cast']); ?></h5>

                                                            <p class="mb-0"><?php echo ($catrun['details']); ?></p>
                                                        </div>
