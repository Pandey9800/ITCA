<?php ob_start();
include_once 'admin/function/db_connect.php'; include_once 'admin/function/function.php'; ?>
<!doctype html>
<html lang="en">
    <head>
        <meta charset="utf-8">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-lg-5 me-lg-auto">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarLightDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">Learn</a>
