...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Comapny | Search Result</title>
 ...
 <input type="submit" name="search" value="Search"/>
	  ...
	  $get_search = "SELECT  `eno`, `prev`, `first_name`, `middle_name`, `last_name`, `father_name`,`present_city`, `mobile_no`,`pan_wallet`, `e_wallet`, `reward_wallet`,`qualificaton`, `state`, `zone`, `dist`, `tehsil`, `ecounter` FROM ecounter WHERE prev like '%$user_keyword%'";
  ...
  while ($row_search = mysqli_fetch_array($run_c)){
	 ...
	 $quli = $row_search['qualificaton'];
	 $roll = $row_search['prev'];
   $i++;
   // $eno = $row ['eno'];
    ?>
  <tr>
