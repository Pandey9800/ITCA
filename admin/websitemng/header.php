...
<head>
    <meta charset="UTF-8">
    <title>TaxJeevan | Dashboard</title>
...
<body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="" class="logo"><b>Tax</b>Jeevan</a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="../../panel/logout.php" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
...
<!--<li class="active treeview">
            ...
            <li class="treeview">
              <a href="">
                ...
                <span>Team Mangement</span><i class="fa fa-angle-left pull-right"></i>
                <!--<span class="label label-primary pull-right">4</span>-->
              </a>
              <ul class="treeview-menu">
                <li><a href="boarmember.php"><i class="fa fa-circle-o"></i>Board Of Member</a></li>
                <li><a href="teamboard.php"><em class="fa fa-circle-o"></em>Team Section</a></li>
              </ul>
            </li>
            <li class="active treeview">
              <a href="download_add.php">
                <i class="fa fa-th"></i> <span>Download Section</span> </a>   </li>
<!--<li>
