...
include_once 'header.php';?>
    ...
    <?php 
	$sqli=mysqli_query($con,"SELECT `id`, `name`, `design`, `nation`, `gender`, `photo` FROM `team` WHERE pid=1");
    ...
    <tr>
      ...
      <td>Edit</td>
      <td><a href="deleteb.php?id=<?php echo $t['id'] ?>">DELETE</a></td>
 ...
 $file_name = $_FILES['photo']['name'];
         ...
         //echo "Success";
				...
				if(mysqli_query($con,"INSERT INTO `team`(`pid`,`name`, `design`, `nation`, `gender`, `photo`) VALUES (1,'$aname','$adesign','$anation','$agender','$file_name')"))
             	{
