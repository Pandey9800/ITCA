...
<html>
  <head>
   ...
   <!--ravi js for dropdown-->
   <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
  <script type="text/javascript" src="rm_js/custom.js"></script>
  <!-- code end  for dropdonw-->
  </head>
  ...
  <form>
    <div class="input-group">
      <select class="form-control" id="zone_list">
        ...
        <?php $result = $con->query("SELECT zone_name FROM zone_list");
            while ($row = $result->fetch_assoc()){ ?>
              <option value="<?php echo $row['eno']; ?>"><?php echo $row['zone_name']; ?></option>
            <?php } ?>
      </select>
    ...
    <br>
    <div class="input-group">
      <select class="form-control" id="dist_list">
    ...
    <div class="input-group">
      ...
      <span class="input-group-addon">CITY/TEHSIL  </span>
    </div>
  </form>
 <!--dropdown ravi end-->
...
//	  $get_search = "SELECT * FROM ecounter WHERE search_keywords like '%$user_keyword%'";
//           
//  $run_c =mysqli_query($con,$get_search);
//  
//  while ($row_search = mysqli_fetch_array($run_c)){
//     $id = $row_search['eno'];
//     $name = $row_search['first_name'];
//	 $city = $row_search['present_city'];
//	 $email = $row_search['Email'];
//	 $quli = $row_search['qualification'];
