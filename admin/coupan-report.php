...
?><div class="content-wrapper"><section class="content-header"><h1><legend>Coupan Report</legend></h1><ol class="breadcrumb"><li><a href="dashboard"><i class="fa fa-dashboard"></i> Home</a></li><li class="active">Coupan Report</li></ol></section>
<section class="content">
<div class="row">
      <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-body box-profile">
              <div align="left">  <br>  <span>Coupan Report List  </span>  <br>    <br>  </div>
<table class="table table-bordered table-responsive" id="example1"><thead>
<tr><th>Sno.</th><th>Coupan</th><th>Category</th><th>Form</th><th>MRP</th><th>Discount</th><th>Actual(Charge) Amount</th><th>Used</th></tr></thead><tbody><!--`catid`,-->
<?php $i=1; $coupansql=mysqli_query($con,"SELECT `id`,`catid`, `formid`, `pin`, `amt`, `disamt`, `status`, `timedate`, `ip` FROM `coupan`");
while($coupanrun=mysqli_fetch_array($coupansql)){?> 
	<tr> 
		...
		<td><?php echo $coupanrun['amt']; ?></td><td><?php echo $coupanrun['disamt']; ?></td><td><?php echo abs($coupanrun['amt']-($coupanrun['disamt'])); ?></td>
		<td>0</td>
			</tr>
