              ...
              <div align="center"><label><font color="#000099">Select Work Area</font></label></div>
                   ...
                   <div class=col-sm-4>
                    <div class="form-group mb-10">
                        ...
                        <?php
       $queryusers = "SELECT `id`, `state`, `dist`, `tehsil` FROM `level` GROUP BY state;";
	...
	<?php
                  ...
                  <div class=col-sm-4>
                    <div class="form-group mb-10">
                        ...
                        <select name="dist[]" class="form-control" multiple>
	  ...
	  <?php
            ...
            <div align="center"><label><font color="#990000">Enter New Zone Member Details</font></label></div>
            <div class="row" style="margin-top: 20px; margin-left: 5px;margin-right: 5px">
...
//   $c_ip = '1';
//   
   $sql = "INSERT INTO `ecounter`(`prev`,`memcode`, `first_name`, `middle_name`, `last_name`, `father_name`, `present_address`, `present_city`, `present_district`, `present_state`, `present_pin_code`, `present_country`, `perm_address`, `perm_city`, `perm_district`, `perm_state`, `perm_pin_code`, `perm_country`, `sex`, `dob`, `martial_status`, `pan_number`, `mobile_no`, `tel_phone_no`, `qualificaton`, `other_qualification`, `Email`, `Password`,`pan_wallet`, `e_wallet`, `reward_wallet`,`state`,`zone`,`fname`,ip)VALUES('$roll','$fcode','$first_name','$middle_name','$last_name','$father_name','$present_address','$present_city','$present_district','$present_state','$present_pin_code','$present_country','$perm_address','$perm_city','$perm_district','$perm_state','$perm_pin_code','$perm_country','$sex','$dob','$martial_status','$pan_number','$mobile_no','$tel_phone_no','$qualification','$other_qualification','$Email','$pass',0,0,0,'$state','$dist','$farm','".$_SERVER['REMOTE_ADDR']."')";
   if (mysqli_query($con, $sql)) {
    echo "<script>alert('ZONE! Account Created Successfully, Thank You!')</script>";
		echo "<script>window.open('userzone.php?name=Zone','_self')</script>";
} else {
...
if(IsInjected($Email))
{
 ...
 include_once '../footer.php'; ?>    <!-- ./wrapper -->
    <!-- jQuery 2.1.3 -->
