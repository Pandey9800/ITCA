<?php
 ...
 include_once 'header.php'; ?>
	...
	<?php
     ...
     <button type="button" class="" data-toggle="modal" data-target="#myModal1">Add New</button>
					  </div>
                    </div>
                  <div class=col-sm-4>
                     <div class="form-group mb-10">
            ...
            <div align="center"><label><font color="red">Enter New Tehsil Member Add</font></label></div>
            <div class="row" style="margin-top: 20px; margin-left: 5px;margin-right: 5px">
                ...
                <div class=col-sm-4>
                 ...
                 <div class=col-sm-4>
                    ...
                    <div class="form-group mb-10">
                        ...
                        <input type="text" value="<?php echo $_GET['name']; ?>" class="form-control" name="roll" required />
                      </div>
                    </div> 
                    </div>
                  
            <input type="submit"  class="btn btn-block btn-primary" name="register" style=" margin-left: 555px; width: 100px;height: 50" value="Register Now" />
   ...
   <!-- Modal content-->
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="ajaxfortehsil.php" method="post">
           <?php $sf=mysqli_query($con,"SELECT `id`, `state`, `dist`, `tehsil` FROM `level` WHERE `state` IS NOT NULL"); ?>
		...
		<?php  while($sl=mysqli_fetch_array($sf)){?>
         ...
         <?php } ?>
           ...
           <?php $sf=mysqli_query($con,"SELECT `id`, `state`, `dist`, `tehsil` FROM `level` WHERE `dist` IS NOT NULL"); ?>
          <select class="form-control" class="form-control" name="ss2">
          <option >Select District</option>
		<?php  while($sl=mysqli_fetch_array($sf)){?>
         <option value="<?php echo $sl['id'] ?>"><?php echo $sl['dist'] ?></option>
         <?php } ?>
          </select>
          <input type="text" placeholder="Enter Tehsil Name" class="form-control" name="ss" />
