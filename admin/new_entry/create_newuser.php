<?php
 ...
 include_once 'header.php'; ?>
        ...
        <div class="content-wrapper">
            ...
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                <a type="button" class="btn btn-box-tool">View List</a>
              </div>
              <!-- /.box-tools -->
            </div>
            <!-- /.box-header -->
            ...
            <div align="center"><label><font color="#000099">Select Work Area</font></label></div>
                   ...
                   <div class=col-sm-4>
                    <div class="form-group mb-10">
                        <label> Select State :<span style="color:red"></span> <button type="button" class="btn btn-link" data-toggle="modal" data-target="#myModal">Add New</button></label>
	...
	<?php
                      ...
                      <div class=col-sm-4>
                     <div class="form-group mb-10">
                        <label>Person/Bussiness/Counter Name<span style="color:red">*</span></label>
                        <input type="text" class="form-control" name="farm" required />
                    </div>
                </div>
            </div>
              <div align="center"><label><font color="#990000">Enter Details of New Member</font></label></div>
            <div class="row" style="margin-top: 20px; margin-left: 5px;margin-right: 5px">
                ...
                <div class=col-sm-4>
                 ...
                 <div class=col-sm-4>
                    ...
                    <div class="form-group mb-10">
                        ...
                        <input type="text" class="form-control" name="mobile_no" maxlength="10" pattern="[789][0-9]{9}" />
                      </div>
                    </div>
                     <div class=col-sm-4>
                    <div class="form-group mb-10">
                        <label>TelPhone No.:<span style="color:red"></span></label>
                        <input type="text" class="form-control" name="tel_phone_no" maxlength="14"  />
                      </div>
                    </div>
                     <div class=col-sm-4>
                    <div class="form-group mb-10">
