...
include_once 'header.php';?>
        <div class="content-wrapper">
            ...
            List Of Applications
                ...
                <?php
				$i=0;
				$app=mysqli_query($con,"SELECT `id`, `form`, `fdate`, `fstatus`, `counter_code`, `fname`, `mname`, `lname`, `ffname`, `fmname`, `flname`, `fmom`, `mmon`, `lmom`, `bod`, `email`, `mobile`, `gender`, `housenum`, `area_street`, `city`, `state`, `pin`, `country`, `id_type`, `add_type`, `bod_type`, `adhar_type`, `id_upload`, `add_upload`, `bod_upload`, `adbar_upload`, `photo_upload`, `upload_sign`, `rcode`, `ip` FROM `form_details` WHERE `form` IS NOT NULL AND  `fstatus`='PENDING' AND form='GST'"); 
                ...
                <td colspan="2"><a href="gst_applicantdetails.php?id=<?php echo $fl['id']?>&name=<?php echo $fl['fname'].'&nbsp;'.$fl['mname']; ?>&cname=<?php echo $fl['counter_code'] ?>">Action</a></td>
                </tr>
                <?php } ?>
