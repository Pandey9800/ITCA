        ...
        <div class="row justify-content-center">
            ...
            if ($result) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    $categoryImage = $row['cat_img'];
                    // Add more variables as needed for other details
            ?>
        ...
        <div class="d-flex">
            <div class="mx-auto text-center">
                <div class="text-center">
                    <?php 
                    $imagePath = 'admin/' . $row['cat_img'];
                    ?>
                    <img src="<?php echo $imagePath; ?>" style="width:100px;height:100px;" alt="<?php echo $row['cast']; ?>"><br/>
                    <h4 class="mb-2" style="font-size:10px;"><?php echo $row['cast']; ?></h4>
                </div>
                <a href="service?catid=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Apply Now</a>
                <br/>
            </div>
        </div>
        <br/>
            ...
            <div class="col-12">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="design-tab-pane" role="tabpanel" aria-labelledby="design-tab" tabindex="0">
                        <div class="row" id="article-slider">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo '<div class="col-md-3" style=" border:1px solid blue;">';
                                    echo '<div class="article-item">';
                                    echo '<h5>' . $row['title'] . '</h>';
                                    $content_excerpt = substr($row['content'], 0, 80);
                                    echo '<p style="font-size: 18px;">' . $content_excerpt . '</p>';
                                    $image_path = 'admin/' . $row['artimg'];
                                    echo '<img src="' . $image_path . '" alt="Article Image" class="img-fluid" style="padding-bottom:5px;"> ';
                                ...
                                if ($counter % 5 != 0) {
                                    echo '</div>'; // Close the row if there are leftover articles
                                }
                            } else {
