    ...
    <div class=" bg-white"  style="border-radius:20px;">
        <div class="d-flex">
            <div class="mx-auto text-center">
                ...
                <img src="./images/gst_icon.png" style="width:100px;height:100px;" alt="GST"><br/>
 ...
 <div class="col-lg-4 col-6 mb-4 mb-lg-0" style="padding-top: 10px; padding-bottom: 10px;border-radius:20px;">
    <div class=" bg-white"  style="border-radius:20px;">
        <div class="d-flex">
            <div class="mx-auto text-center">
                             <div class="text-center">
                <img src="./images/itr_icon.png" style="width:100px;height:100px;" alt="ITR Filing"><br/>
 ...
 <div class="col-lg-4 col-6 mb-4 mb-lg-0" style="padding-top: 10px; padding-bottom: 10px;border-radius:20px;">
    <div class=" bg-white"  style="border-radius:20px;">
        <div class="d-flex">
            <div class="mx-auto text-center">
                             <div class="text-center">
                <img src="./images/tds_icon.png" style="width:100px;height:100px;" alt="TDS / TCS"><br/>
 ...
 <div class="col-lg-4 col-6 mb-4 mb-lg-0" style="padding-top: 10px; padding-bottom: 10px;border-radius:20px;">
    <div class=" bg-white"  style="border-radius:20px;">
        <div class="d-flex">
            <div class="mx-auto text-center">
                             <div class="text-center">
                <img src="./images/pf_icon.png" style="width:100px;height:100px;" alt="PF & ESIC"><br/>
 ...
 <div class="col-lg-4 col-6 mb-4 mb-lg-0" style="padding-top: 10px; padding-bottom: 10px;border-radius:20px;">
    <div class=" bg-white"  style="border-radius:20px;">
        <div class="d-flex">
            <div class="mx-auto text-center">
                             <div class="text-center">
                <img src="./images/cma_icon.png" style="width:100px;height:100px;" alt="Project & CMA Report"><br/>
 ...
 <div class="col-lg-4 col-6 mb-4 mb-lg-0" style="padding-top: 10px; padding-bottom: 10px;border-radius:20px;">
    <div class=" bg-white"  style="border-radius:20px;">
        <div class="d-flex">
            <div class="mx-auto text-center">
                             <div class="text-center">
                <img src="./images/msme_icon.png" style="width:100px;height:100px;" alt="MSME Registration"><br/>
 ...
 <div class="col-lg-4 col-6 mb-4 mb-lg-0" style="padding-top: 10px; padding-bottom: 10px;border-radius:20px;">
    <div class=" bg-white"  style="border-radius:20px;">
        <div class="d-flex">
            <div class="mx-auto text-center">
                             <div class="text-center">
                <img src="./images/audit_icon.png" style="width:100px;height:100px;" alt="Audit & Accounting/Bookkeeping"><br/>
 ...
 <div class="col-lg-4 col-6 mb-4 mb-lg-0" style="padding-top: 10px; padding-bottom: 10px;border-radius:20px;">
    <div class=" bg-white"  style="border-radius:20px;">
        <div class="d-flex">
            <div class="mx-auto text-center">
                             <div class="text-center">
                <img src="./images/company.png" style="width:100px;height:100px;" alt="Company Incorporation & ROC Compliance"><br/>
 ...
 <div class="col-lg-4 col-6 mb-4 mb-lg-0" style="padding-top: 10px; padding-bottom: 10px;border-radius:20px;">
    <div class=" bg-white"  style="border-radius:20px;">
        <div class="d-flex">
            <div class="mx-auto text-center">
                             <div class="text-center">
                <img src="./images/tax_icon.png" style="width:100px;height:100px;" alt="Tax Planning & Consultation"><br/>
 ...
 <div class="col-lg-4 col-6 mb-4 mb-lg-0" style="padding-top: 10px; padding-bottom: 10px;border-radius:20px;">
    <div class=" bg-white"  style="border-radius:20px;">
        <div class="d-flex">
            <div class="mx-auto text-center">
                             <div class="text-center">
                <img src="./images/other_icon.png" style="width:100px;height:100px;" alt="Other Services"><br/>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12">
                            <img src="./images/aboutitax.jpg" class="img-fluid" alt="FAQs">
                        </div>
