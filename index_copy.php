...
<!-- sewrivce detail -->
<?php $serv=mysqli_query($con,"SELECT `id`, `catid`, `name`,`sdetail`, `cost`, `advrequired`, `advper`, `duedays`, `duepay`, `type`, `pic`, `timedate` FROM `service` ORDER BY id DESC LIMIT 10" );
//$runservicef=mysqli_fetch_array($smyerv); 

// $i=0;while($runs=mysqli_fetch_array($serv)){$i++;?>
                        <!-- <div class="col-lg-4 col-12 mb-4 mb-lg-0" style="padding-top: 10px; padding-bottom: 10px;">
    <div class="custom-block bg-white shadow-lg">
        <div class="d-flex">
            <div class="mx-auto text-center">
                <h4 class="mb-2"><?php echo $runs['name'];?></h4>
                <p class="mb-0"><?php echo $runs['sdetail'];?></p>
            </div>
        </div> -->
       <!-- <?php if($runs['pic'] != ''){ ?> -->
            <!-- <div class="text-center mt-2">
                <img src="./images/<?php echo $runs['pic'];?>" style="width:100%; height:250px;" alt="">
            </div> -->
       <!-- <?php } else { 
         //   echo '<p style="width:600px;height:230px;"></p>';
       //  } ?>
        <!-- <br/> -->
        <!-- <a href="apply.php?service_id=<?php echo $runs['id']?>" class="btn custom-btn mt-2 mt-lg-3">Apply Now</a>
    </div>
</div> -->
        ...
        <div class="d-flex flex-column h-100">
            ...
            <div class="custom-block-overlay-text d-flex">
                <div>
                    ...
                    <a href="apply" class="btn custom-btn mt-2 mt-lg-3">Learn More</a>
                </div>
...
<section class="explore-section section-padding" id="section_2">
    <div class="container">
                        <div class="col-12 text-center">
                            <h2 class="mb-4">Our Categories</h1>
                        </div>
        ...
        <div class="col-12">
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="design-tab-pane" role="tabpanel" aria-labelledby="design-tab" tabindex="0">
                    <div class="row">
                        <?php 
                        $catq=mysqli_query($con,"SELECT `id`, `cast`, `timedate` FROM `cat` ORDER BY `cast` DESC");
                         while($catrun=mysqli_fetch_array($catq)){?>
                        <div class="col-lg-4 col-md-6 col-12 mb- mb-lg-4">
                            <div class="custom-block bg-white shadow-lg">
                                <a href="service-list.php?sid=<?php echo $catrun['id']; ?>">
                                    <div class="d-flex">
                                        <div>
                                            <h5 class="mb-2"><?php echo ucwords($catrun['cast']); ?></h5>
                                        </div>
                                        <span class="badge bg-design rounded-pill ms-auto">14</span>
                                    </div>
                                    <img src="images/undraw_Remote_design_team_re_urdx.jpg" class="custom-block-image img-fluid" alt="">
                                    <br/>
                                    <div class="text-center">
                                        <a class="btn btn-primary" href="service-list.php?sid=<?php echo $catrun['id']; ?>">Apply Now</a>
                                    </div>
                                </a>
                            </div>
                        </div>
