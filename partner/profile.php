...
$sql =mysqli_query($con,"UPDATE `ecounter` SET `pic`='$img' WHERE `eno`='".$_SESSION['partid']."'");
if($sql>0){
...
$sql =mysqli_query($con,"UPDATE `ecounter` SET `Password`='$newpassa' WHERE `eno`='".$_SESSION['partid']."'");
if($sql>0){
